...
var render = function render() {
  ...
  return _c(vuetify_lib_components_VGrid__WEBPACK_IMPORTED_MODULE_0__["default"], {}, [_c(vuetify_lib_components_VGrid__WEBPACK_IMPORTED_MODULE_1__["default"], [_c(vuetify_lib_components_VGrid__WEBPACK_IMPORTED_MODULE_2__["default"], [_c("div", {
    ...
    scopedSlots: _vm._u([{
      key: "default",
      fn: function fn() {
        return [_c("thead", [_c("tr", [_c("th", [_vm._v("Blog Title")]), _vm._v(" "), _vm.$vuetify.breakpoint.mdAndUp ? _c("th", [_vm._v("Created at")]) : _vm._e(), _vm._v(" "), _vm.$vuetify.breakpoint.mdAndUp ? _c("th", [_vm._v("Updated At")]) : _vm._e(), _vm._v(" "), _c("th", [_vm._v("Published")]), _vm._v(" "), _c("th", [_vm._v("Action")])])]), _vm._v(" "), _c("tbody", _vm._l(_vm.loadedBlogs.data, function (blog, index) {
          return _c("tr", {
            key: index
          }, [_c("td", [_c("Link", {
            ...
            staticClass: "no-underline text-black line-clamp-2",
            domProps: {
              textContent: _vm._s(blog.title)
            }
          })])], 1), _vm._v(" "), _vm.$vuetify.breakpoint.mdAndUp ? _c("td", [_vm._v("\n                " + _vm._s(_vm._f("moment")(blog.created_at, "calendar")) + "\n              ")]) : _vm._e(), _vm._v(" "), _vm.$vuetify.breakpoint.mdAndUp ? _c("td", [_vm._v("\n                " + _vm._s(_vm._f("moment")(blog.updated_at, "calendar")) + "\n              ")]) : _vm._e(), _vm._v(" "), _c("td", [_c(vuetify_lib_components_VBtn__WEBPACK_IMPORTED_MODULE_5__["default"], {
            attrs: {
              "x-small": "",
              elevation: "",
              rounded: "",
